...
* xref:../4.guide/4d.sockets.adoc[Sockets Guide] — The socket interface mockets implement
* xref:../4.guide/4m.error-handling.adoc[Error Handling] — Testing error paths
