...
See xref:4g.composed-operations.adoc[Composed Operations] for details.
...
See xref:4n.buffers.adoc[Buffer Sequences] for details.
...
* xref:4e.tcp-acceptor.adoc[Acceptors] — Accept incoming connections
* xref:4f.endpoints.adoc[Endpoints] — IP addresses and ports
