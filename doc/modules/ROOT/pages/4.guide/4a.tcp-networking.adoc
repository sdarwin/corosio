...
* xref:4b.concurrent-programming.adoc[Concurrent Programming] — Coroutines and strands
* xref:4c.io-context.adoc[I/O Context] — The event loop
* xref:4d.sockets.adoc[Sockets] — Socket operations in detail
